...
$(TARGET): $(BIN_OUTPUT_DIR) $(EXESOURCEOFILE) $(LIBTARGET_INPUT) $(LIBTARGET_BIG_INTEGER) $(LIBTARGET_BASE_N_INTEGER_LIST) $(LIBTARGET_BASE_N_INTEGER_LIST_OF_LIST) $(LIBTARGET_UTIL) $(MENUSOURCEOFILE)
	@echo "\n Generating the executable " $@
	$(CXX) $(CFLAGS) $(EXESOURCEOFILE) -l$(LIBTARGET2_UTIL) -l$(LIBTARGET2_INPUT) -l$(LIBTARGET2_BIG_INTEGER) -l$(LIBTARGET2_BASE_N_INTEGER_LIST) -l$(LIBTARGET2_BASE_N_INTEGER_LIST_OF_LIST) $(LIBSDIR) $(MENUSOURCEOFILE) -o $(BIN_OUTPUT_DIR)$(TARGET)
...
$(LIBTARGET_BASE_N_INTEGER_LIST_OF_LIST): $(LIB_OUTPUT_DIR) $(LIBSOURCEOFILE_BASE_N_INTEGER_LIST_OF_LIST)
	...
	$(CXX) $(CFLAGS) -shared $(LIBSOURCEOFILE_BASE_N_INTEGER_LIST) -o $(LIB_OUTPUT_DIR)$(LIBTARGET_BASE_N_INTEGER_LIST_OF_LIST)
