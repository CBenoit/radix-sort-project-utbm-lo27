...
$(TARGET): $(BIN_OUTPUT_DIR) $(EXESOURCEOFILE) $(LIBTARGET_INPUT) $(LIBTARGET_BIG_INTEGER) $(LIBTARGET_BASE_N_INTEGER_LIST) $(LIBTARGET_BASE_N_INTEGER_LIST_OF_LIST) $(LIBTARGET_UTIL) $(MENUSOURCEOFILE)
	@echo "\n Generating the executable " $@
	$(CXX) $(CFLAGS) $(EXESOURCEOFILE) $(MENUSOURCEOFILE) -l$(LIBTARGET2_UTIL) -l$(LIBTARGET2_INPUT) -l$(LIBTARGET2_BIG_INTEGER) -l$(LIBTARGET2_BASE_N_INTEGER_LIST) -l$(LIBTARGET2_BASE_N_INTEGER_LIST_OF_LIST) $(LIBSDIR) -o $(BIN_OUTPUT_DIR)$(TARGET)
