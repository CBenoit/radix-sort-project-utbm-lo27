...
\emph{insertHead}: \emph{BaseNIntegerList} \(\times\) \emph{Array<Character>} \(\rightarrow\) \emph{BaseNIntegerList},
adds the specified integer (\emph{Array<Character>}, represented in the considered base) at the beginning
...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}
        \Function{insertHead}{\(l\) : BaseNIntegerList, value : Array<Character>} : BaseNIntegerList
...
\emph{insertTail}: \emph{BaseNIntegerList} \(\times\) \emph{Array<Character>} \(\rightarrow\) \emph{BaseNIntegerList},
...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}
        \Function{insertTail}{\(l\) : BaseNIntegerList, value : Array<Character>} : BaseNIntegerList
            \State new\_el \(\leftarrow\) create(BaseNIntegerElement)
...
\emph{sumBaseNIntegers}: \emph{Array<Character>} \(\times\) \emph{Array<Character>} \(\times\) \emph{Integer} \(\rightarrow\) \emph{Array<Character>},
...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}
        \Function{sumBaseNIntegers}{\(a\) : Array<Character>, \(b\) : Array<Character>, base : \emph{Integer}} : Array<Character>
            \State Integer sizeA \(\leftarrow\) size(a)
            \State Integer sizeB \(\leftarrow\) size(b)
            \State Integer sizeC \(\leftarrow\) max(sizeA, sizeB)
            \State Array<Character> result \(\leftarrow\) createString(sizeC)
...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}
        \Function{sumIntegerList}{\(l\) : BaseNIntegerList} : Array<Character>
            \State Array<Character> sum \(\leftarrow\) createString(0)
...
\emph{baseNToDecimal}: \emph{Array<Character> x Integer} \(\rightarrow\) \emph{Integer},
converts the specified integer (Array<Character>) represented with the specified base (Integer, second parameter) into a corresponding integer in base 10.
...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}
        \Function{baseNToDecimal}{n : Array<Character>, base : integer} : integer
